...
static const struct imx477_reg mode_2028x1520_regs[] = {
	...
	// binning
	{ 0x0900, 0x01 },
	{ 0x0901, 0x12 }, // 2 or 3, 1/2 or 1/3 scaling
	{ 0x0902, 0x02 },

	// scale
	{ 0x0401, 0x01 }, // horizontal ?
	{ 0x0404, 0x0020 }, // 1/2 scaling
...
static const struct imx477_reg mode_2028x1080_regs[] = {
	// line length
	{ 0x0342, 0x31c4 },
	// x/y start & end addresses (double the size, then bin?)
	{ 0x0344, 0x0000 }, // start x,y   = (0, 440)
	{ 0x0346, 0x01b8 }, // end   x,y   = (4055, 2599)
	{ 0x0348, 0x0fd7 }, // size  x,y   = (4056, 2160)
	{ 0x034a, 0x0a27 }, // 4056,2160/2 = (2028, 1080)
	// hdr
	{ 0x0220, 0x00 },
	{ 0x0221, 0x11 },
	// x/y even & odd increments
	...
	// binning
	{ 0x0900, 0x01 }, // enabled
	{ 0x0901, 0x12 }, // 1/2 or 1/3
	{ 0x0902, 0x02 }, // weighted average
	// scale
	{ 0x0401, 0x01 }, // horizontal ?
	{ 0x0404, 0x0020 }, // 32 = x2 scale
	// crop
	{ 0x0408, 0x0000 },
	{ 0x040a, 0x0000 },
	{ 0x040c, 0x0fd8 }, // 4056
...
static const struct imx477_reg mode_1332x990_regs[] = {
	{ 0x0112, 0x0a0a }, // data format = 10 bit!
	{ 0x0114, 0x01 }, // lanes = 2
	{ 0x0342, 0x1a08 }, // line length = 6664
	{ 0x0340, 0x041a }, // frame length = 1050
	// x/y start & end addresses
	{ 0x0344, 0x0000 }, // start x,y =  (0, 528)
	{ 0x0346, 0x0210 }, // end   x,y =  (4055, 2511)
	{ 0x0348, 0x0fd7 }, // size  x,y =  (4056, 1984)
	{ 0x034a, 0x09cf }, // size  / 2 =  (2028, 992) ???
	...
	// binning
	{ 0x0900, 0x01 }, // enabled
	{ 0x0901, 0x22 }, // 4x4 i guess?
	{ 0x0902, 0x02 }, // weighted average
	// scale
	{ 0x0401, 0x00   }, // no scaling?
	{ 0x0404, 0x0010 }, // 16 = x1 scale?
	// digital crop
	{ 0x0408, 0x015c }, // 348
	{ 0x040a, 0x0000 }, // 0
	{ 0x040c, 0x0534 }, // 1332
...
// taken from
// https://isrc.iscas.ac.cn/gitlab/mirrors/github.com/raspberrypi_linux/-/blob/4f27006dfc32c0429162aece121edaebe9166d93/drivers/media/i2c/imx477.c
/* 4x4 binned. 120fps */
static const struct imx477_reg mode_1012x760_regs[] = {
	{ 0x0112, 0x0a0a }, // data format = 10 bit
	{ 0x0114, 0x01 }, // lanes = 2
	{ 0x0342, 0x1460 }, // line length = 5216
	// x/y start & end addresses
	{ 0x0344, 0x0000 }, // start x,y = (0,    0)
	{ 0x0346, 0x0000 }, // end   x,y = (4051, 3039)
	{ 0x0348, 0x0fd3 }, // size  x,y = (4052, 3040)
	{ 0x034a, 0x0bdf }, // size / 4  = (1013,  760)
	...
	// x/y even & odd increments
	{ 0x0381, 0x01 }, // x even = 1
	{ 0x0383, 0x01 }, // x odd  = 1
	{ 0x0385, 0x01 }, // y even = 1
	{ 0x0387, 0x03 }, // y odd  = 3
	...
	// scale
	{ 0x0401, 0x01 },   // enabled
	{ 0x0404, 0x0020 }, // 32 = 2x scale

	// digital crop
	{ 0x0408, 0x0000 }, // x = 0
	{ 0x040a, 0x0000 }, // y = 0
	{ 0x040c, 0x07ea }, // w = 2026
	{ 0x040e, 0x02f8 }, // h =  760

	// x/y output size
	{ 0x034c, 0x03f4 }, // x = 1012
	{ 0x034e, 0x02f8 }, // y =  760

	// clocks
	{ 0x0301, 0x05 },   // vt pix clk div = 5
	{ 0x0303, 0x02 },   // vt sys clk div = 2
	{ 0x0305, 0x02 },   // vt pre pll div = 2
	{ 0x0306, 0x00af }, // vt pll mult    = 175
	{ 0x0309, 0x0a },   // op pix clk div = 10
	{ 0x030b, 0x02 },   // op sys clk div = 2
	{ 0x030d, 0x02 },   // op pre pll div = 2
	{ 0x030e, 0x0096 }, // op pll mult    = 175
	{ 0x0310, 0x01 },   // pll mult drive = 1
